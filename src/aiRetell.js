...
быть основной текст статьи или короткий RSS-анонс. Подготовь самостоятельную
публикацию: добавь читателю ясность и контекст, а не механически переписывай
RSS. Не выдумывай факты, даты, цифры, должности, причины или последствия. Не
копируй фразы источника дословно, избегай кликбейта и оценочных суждений.
...
2. summaryRu — начни с блока «Кратко» (3–4 предложения: что произошло, где,
   когда и кого касается), затем добавь «Подробности», «Почему это важно?» и
   «Источник». Разделяй блоки пустой строкой. В «Почему это важно?» объясняй
   только подтверждённые последствия; если их нет, напиши: «Новость носит
   информационный характер; дополнительных последствий источник не сообщает.»
   Если дан основной текст статьи, сделай содержательный пересказ в 6–10
   ...
   В блоке «Источник» укажи название переданного финского СМИ. Не добавляй
   внешний контекст, которого нет в исходном тексте.
