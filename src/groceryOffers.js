const GROCERY_CHAINS = Object.freeze([
  ...
  { id: 'prisma', name: 'Prisma', offersUrl: 'https://www.s-kaupat.fi/sivu/tarjoukset', storesUrl: 'https://www.s-kaupat.fi/myymalat/prisma' },
  { id: 'smarket', name: 'S-market', offersUrl: 'https://www.s-kaupat.fi/sivu/tarjoukset', storesUrl: 'https://www.s-kaupat.fi/myymalat/s-market' },
  { id: 'alepa', name: 'Alepa', offersUrl: 'https://www.s-kaupat.fi/sivu/tarjoukset', storesUrl: 'https://www.s-kaupat.fi/myymalat/alepa' },
  { id: 'kmarket', name: 'K-Market', offersUrl: 'https://www.k-ruoka.fi/kauppa', storesUrl: 'https://www.k-ruoka.fi/kauppa' },
  { id: 'kcitymarket', name: 'K-Citymarket', offersUrl: 'https://www.k-ruoka.fi/k-citymarket', storesUrl: 'https://www.k-ruoka.fi/kauppa' },
]);
